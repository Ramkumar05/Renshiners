...
function doSubmit()
{
	document.slamform.work.value="slam";
	document.slamform.method="post";
	document.slamform.action="General";
	document.slamform.submit();
}
</script>
</head>
<body>
...
<table width=100% height=100%>
	<tr>
		<td width=300 id="tr1" valign="top">
		<b>Your Name</b>
		</td>
		<td id="tr2" width=500>
		<input type="text" name="nmetxt" size=30>
		</td>
	</tr>
	<tr>
		<td width=300 id="tr1" valign="top">
	...
	<td id="tr2" width=500>
		<textarea name="slmtxt" cols="100" rows="40">
		</textarea>
		<br>
		<center><input type="button" value="Submit" onclick="doSubmit()">
		</center>
		</td>
	</tr>
