...
<script>
	...
	{
		//alert(id);
		window.open("/Coupons/showcode.jsp?nos="+id+"","_blank","toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=800, height=400");
	}	
   function blink() {
	   //alert("hello");
...
<td colspan="5"><hr></td>
	...
	<tr id="tab">
		...
		<td><%=website %></td>
		<td><%=desc %></td>
		<td align="center" style=cursor:pointer;><span class="code-button" onclick="doShow(<%=i %>)">Click Here</span></td>
		<td><%=exp %></td>
	</tr>
<%} %>
</table>
