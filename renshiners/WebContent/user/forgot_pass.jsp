...
<script>
	  function doLogin()
	  {
		  ...
		  {
			  document.indFrm.taskId.value="send-mail";
...
<input type="hidden" name="taskId">
  ...
  <p>
    <label for="message"><b>Kindly Check Your Inbox or Spam After it Redirect to Login Page</b></label>
  </p>
  </div>
   <p>
  ...
  <p class="p-container">
    ...
    <input type="button" name="go" id="go" value="Submit" onclick="doLogin()">
  </p>
</form>
