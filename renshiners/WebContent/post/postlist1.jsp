...
function doView()
{
	document.postform.work.value="postview";
...
<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span><strong>Cinema</strong><span class="navi-description">All Cinema Updates</span></span></a>
<ul class="sub-menu">
	<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Songs</span></a></li>
	<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Videos</span></a></li>
    <li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>News</span></a></li>
	
	</ul>
</li>

<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span><strong>Tutorials</strong><span class="navi-description">Useful Tutorials</span></span></a>
<ul class="sub-menu">
...
<li><a href="MainController?taskId=postlist1" STYLE="text-decoration: none"><span><strong>Sports</strong><span class="navi-description">All Sports Updates</span></span></a>
<ul class="sub-menu">
	<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Scores</span></a></li>
	<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>News</span></a></li>
	<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Rankings</span></a></li>
</ul>	
</li>

<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span><strong>News</strong><span class="navi-description">Breaking News</span></span></a>
<ul class="sub-menu">
	<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Current</span></a></li>
<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Local</span></a></li>
<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>World</span></a></li>
...
<ul class="sub-menu">
	...
	<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Latest Products</span></a></li>
<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Cars</span></a></li>
<li><a href="General?taskId=postlist1" STYLE="text-decoration: none"><span>Bikes</span></a></li>
...
{
	vv6=(Vector)session.getAttribute("date");
}
...
String[] date=new String[vv1.size()];
...
<table id="tablee" height=40% width=120%>
<%
for(i=vv1.size()-1;i>=0;i--)
{
%>
    	<tr >
    		
    		
	        	<td height="30%" colspan=2><a href="General?taskId=postview&x=<%=id[i]%>" STYLE="text-decoration: none"><label id="list1"><%=title[i] %></label></a></td>
	            
	            <td height="30%"><a href="General?taskId=postview&x=<%=id[i]%>" STYLE="text-decoration: none"><label id="list3">Category:<%=category[i] %></label></a>
</td>
    	...
    	<tr >
            ...
            <td height="50%" width=20%>  <a href="General?taskId=postview&x=<%=id[i]%>" STYLE="text-decoration: none"><img src="post_images/<%=img[i] %>" width=100 height=100></a>
            </td>
            <td height="50%" id="td1" colspan="1">
	        	
	        	
	        	<a href=General?taskId=postview&x=<%=id[i]%>" STYLE="text-decoration: none"> <%=sd[i] %></a>
	        	
        	</td>
        	<td height="50%" width=30% id="td3"><a href="General?taskId=postview&x=<%=id[i]%>" STYLE="text-decoration: none"> <label id="list2">Posted On:<%=date[i] %></label></a></td>
