...
if(session.getAttribute("pcategory")!=null)
{
	category=(String)session.getAttribute("pcategory");
}
if(session.getAttribute("ptitle")!=null)
{
	title=(String)session.getAttribute("ptitle");
}
if(session.getAttribute("psd")!=null)
{
	sd=(String)session.getAttribute("psd");
}

if(session.getAttribute("pd")!=null)
{
	v1=(Vector)session.getAttribute("pd");
}
if(session.getAttribute("pimg")!=null)
{
	img=(String)session.getAttribute("pimg");
}
if(session.getAttribute("pdate")!=null)
{
	date=(String)session.getAttribute("pdate");
}
String[] d=new String[v1.size()];
%>
...
<table width="100%" height="100%" border="0">
       ...
       <tr>
        ...
        <tr>
        	<td width="100%">
            	<label id="desc"><%=sd %></label>,&nbsp;&nbsp;&nbsp;&nbsp;Posted on : <label id="desc1"><%=date %></label>
            </td>
        </tr>
         <tr>
        
        	<td width="100%" align="center" colspan="1" >
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="post_images/<%=img %>" width=420 height=300/>
